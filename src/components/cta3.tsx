...
export const CallToAction3 = () => {
  return (
    <div className="bg-white w-full">
      <section className="rounded-b-[64px] overflow-hidden relative bg-neutral-900 drop-shadow-2xl z-20 text-white">
        <div className="flex flex-col items-center py-10 mt-4 ">
          <h3 className="md:text-[60px] text-2xl py-4 font-bold">
            One-Click to Create
          </h3>
          ...
          <a
            href="/"
            className="bg-neutral-800 text-white flex items-center rounded-xl justify-center px-4 py-3 w-fit font-semibold gap-x-1 mt-5"
          >
