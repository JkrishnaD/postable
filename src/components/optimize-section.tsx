...
export const OptimizationSection = () => {
  return (
    <section className="mx-auto flex flex-col max-w-6xl items-center w-full py-10 mb-4">
      <div className="flex flex-col justify-items-start">
        ...
        <div className="flex md:flex-row flex-col space-y-2 px-2 py-4">
          <div className="text-[14px] w-fit max-w-xl leading-[20px md:text-balance md:text-base]">
